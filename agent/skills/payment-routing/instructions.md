...
For immediate internal Agent-to-Agent payments that do not need acceptance, route with deliveryMode=agent_transfer and use only agent_wallet_transfer with fromEmail, toEmail, and amountAtomic. Do not pass agent ids for direct transfers.
