...
DEFAULT_PUBLIC_LEDGER_URL = "https://ledger.kovaloop.ai"
SESSION_COOKIE = "kovaloop_ledger_session"
ADMIN_COOKIE = "kovaloop_ledger_admin"
OAUTH_STATE_COOKIE = "kovaloop_ledger_oauth_state"
OAUTH_RETURN_COOKIE = "kovaloop_ledger_oauth_return"
